...
/**
 * Class represents the custom {@link RuntimeException} exception that is thrown
 * in case the initialization of the generator fails.
...
public class SnowflakeGeneratorInitializationException extends RuntimeException {
  ...
  public SnowflakeGeneratorInitializationException(String reason, Throwable cause) {
    super(String.format(
        "Error occurred while initializing the SnowflakeGenerator. Reason: %s", reason), cause);
  }
  ...
  public SnowflakeGeneratorInitializationException(
    ...
    super(String.format(
        "Error occurred while initializing the SnowflakeGenerator. Reason: %s", reason), cause, enableSuppression, writableStackTrace);
  }
}

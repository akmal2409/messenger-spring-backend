...
/**
 * The class represents a custom condition that decides whether to enable the bean or not.
 *
...
public class ScriptInitCondition implements Condition {
  ...
  public boolean matches(ConditionContext context, AnnotatedTypeMetadata metadata) {
    final var env = Objects.requireNonNull(context.getEnvironment(), "Environment " + "was null");
    ...
    if (initSchema || initData) {
      log.info(
          "Enabling SessionFactoryInitializer bean because either schema.init "
